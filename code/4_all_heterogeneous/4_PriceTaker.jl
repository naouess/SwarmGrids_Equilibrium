...
using PATHSolver
# Using the free license which is valid for only one year and resets annually in December
...
begin
    ...
    # @variable(model, sl[t in timesteps, i in nanogrids] >= 0)
...
savefig(plot_combined, "$dir/prices_and_duals_micro_nano.png")
...
savefig(p_all, "$dir/prices_and_duals_micro_nano_oneplot")
