...
e_dem = CSV.read("$dir/Nanogrids_demands_365days_15min_homo.csv", DataFrame)[:, 1:3]
...
c_B = [0.384, 0.384, 0.384] .* annualized # * factor  # Cost per unit capacity of battery system (euro/kWh)
m = [10., 10., 10.]

c_bat = 0.0005 # .* factor       # Marginal cost for battery operation (charge and discharge) (euro/kWh)
c_ie = 0.0001 # .* factor   # Marginal cost of energy sharing
